...
#define DATA_FILE_1 "data\\[001J]Glycerin(No_Target)(1.4-3.2).csv"
#define DATA_FILE_2 "data\\Test0.csv"
...
#define OUTER_PERMITTIVITY 50

#define RELATIVE_PERMITTIVITY 50 // Relative permittivity of subject

#define IMAGING_DOMAIN_RADIUS 0.07
...
#define IMAGING_DOMAIN_POINTS 3136
